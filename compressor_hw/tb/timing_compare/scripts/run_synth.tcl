# run_synth.tcl — Synthesize compressor for Pynq-Z2 timing benchmark
...
set top_file [file join $src_dir compressor_timing_top.sv]
set rtl_files [list \
...
set xdc_file [file join $root_dir constraints compressor.xdc]

puts "=== Synthesis timing benchmark ==="
puts "Part:    $part"
puts "Top:     compressor_timing_top"
puts "RTL:     $rtl_dir"
...
if {[file exists $xpr_file]} {
    ...
    set_property top compressor_timing_top [current_fileset]
    set_property top_file $top_file [current_fileset]
    update_compile_order -fileset sources_1
    reset_run synth_1
} else {
    create_project compressor_timing_synth $build_dir -part $part
